...
import pe.edu.upeu.appturismo202501.ui.presentation.screens.welcome.favoritos.FavoritosScreen
...
fun WelcomeMain() {
    ...
    Scaffold(
        ...
        NavHost(
            ...
            composable(BottomDestination.FAVORITOS.route) { FavoritosScreen() }
